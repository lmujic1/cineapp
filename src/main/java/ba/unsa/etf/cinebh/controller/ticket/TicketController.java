package ba.unsa.etf.cinebh.controller.ticket;

import ba.unsa.etf.cinebh.dto.request.auth.PaymentRequest;
import ba.unsa.etf.cinebh.dto.request.ticket.TicketRequest;
import ba.unsa.etf.cinebh.dto.response.NumberOfElementsResponse;
import ba.unsa.etf.cinebh.dto.response.PaymentResponse;
...
public class TicketController {
  ...
  public ResponseEntity<List<Ticket>> getTicketsForProjection(@PathVariable long id, Date date) {
    ...
    return ResponseEntity.ok(ticketService.getTicketsForProjection(p, date));
  }
