...
import ba.unsa.etf.cineapp.dto.request.movie.CurrentlyMoviesFilterParams;
import ba.unsa.etf.cineapp.dto.request.movie.StatusParams;
import ba.unsa.etf.cineapp.dto.request.movie.UpcomingMoviesFilterParams;
...
import ba.unsa.etf.cineapp.repository.movie.MovieRepository;
import ba.unsa.etf.cineapp.repository.venue.VenueRepository;
import ba.unsa.etf.cineapp.service.auth.AmazonService;
import ba.unsa.etf.cineapp.service.image.ImageService;
import ba.unsa.etf.cineapp.specification.MovieSpecification;
...
public class MovieService {
  ...
  public void deleteImages(final long movieId, final List<Long> imageIds) {
    ...
    for (final Long id : imageIds) {
      ...
      if (image != null && images.contains(image)) {
        amazonService.deleteFileFromS3Bucket(image.getLink());
        images.remove(image);
