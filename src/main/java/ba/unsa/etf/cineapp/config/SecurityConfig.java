  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http.csrf(AbstractHttpConfigurer::disable)
        .authorizeHttpRequests(request -> request.requestMatchers(HttpMethod.GET, "api/movies/**", "api/venues/**", "api/projections/**", "api/genres", "api/cities", "api/countries")
            ...
            .requestMatchers(HttpMethod.POST, "api/user/**", "api/movies/**", "api/venues/**", "api/actors", "api/writers", "api/images").hasAnyAuthority(Role.SUPERADMIN.name())
            .requestMatchers(HttpMethod.PUT,"api/movies/**", "api/venues", "api/actors", "api/writers", "api/images").hasAnyAuthority(Role.SUPERADMIN.name())
            .requestMatchers(HttpMethod.DELETE, "/api/user/**", "api/movies/**", "api/venues", "api/actors", "api/projections/**", "api/writers", "api/images").hasAnyAuthority(Role.SUPERADMIN.name())
            ...
            .requestMatchers(HttpMethod.GET, "/api/user/**").hasAnyAuthority(Role.SUPERADMIN.name())
