package ba.unsa.etf.cineapp.repository.ticket;
...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
  ...
  List<Ticket> findTicketsByProjectionAndDate(final Projection projection, final Date date);

  @Query("SELECT r FROM Ticket r WHERE r.projection = :projection AND r.date = :date")
  List<Ticket> findAllTicketsByProjectionAndDate(final Projection projection, final Date date);
